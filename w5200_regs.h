...
#define W52_SOCK_MR 0x4000
#define W52_SOCK_CR 0x4001
#define W52_SOCK_IR 0x4002
#define W52_SOCK_SR 0x4003

#define W52_SOCK_SRCPORT 0x4004
#define W52_SOCK_PORT0 0x4004
#define W52_SOCK_PORT1 0x4005

#define W52_SOCK_DESTMAC 0x4006
#define W52_SOCK_DHAR0 0x4006
#define W52_SOCK_DHAR1 0x4007
#define W52_SOCK_DHAR2 0x4008
#define W52_SOCK_DHAR3 0x4009
#define W52_SOCK_DHAR4 0x400A
#define W52_SOCK_DHAR5 0x400B

#define W52_SOCK_DESTIP 0x400C
#define W52_SOCK_DIPR0 0x400C
#define W52_SOCK_DIPR1 0x400D
#define W52_SOCK_DIPR2 0x400E
#define W52_SOCK_DIPR3 0x400F

#define W52_SOCK_DESTPORT 0x4010
#define W52_SOCK_DPORT0 0x4010
#define W52_SOCK_DPORT1 0x4011

#define W52_SOCK_MSS 0x4012
#define W52_SOCK_MSSR0 0x4012
#define W52_SOCK_MSSR1 0x4013

#define W52_SOCK_PROTO 0x4014
#define W52_SOCK_TOS 0x4015
#define W52_SOCK_TTL 0x4016

#define W52_SOCK_RXMEM_SIZE 0x401E
#define W52_SOCK_TXMEM_SIZE 0x401F

#define W52_SOCK_TXFREE_SIZE 0x4020
#define W52_SOCK_TX_FSR0 0x4020
#define W52_SOCK_TX_FSR1 0x4021

#define W52_SOCK_TX_READPTR 0x4022
#define W52_SOCK_TX_RD0 0x4022
#define W52_SOCK_TX_RD1 0x4023

#define W52_SOCK_TX_WRITEPTR 0x4024
#define W52_SOCK_TX_WR0 0x4024
#define W52_SOCK_TX_WR1 0x4025

#define W52_SOCK_RX_RECVSIZE 0x4026
#define W52_SOCK_RX_RSR0 0x4026
#define W52_SOCK_RX_RSR1 0x4027

#define W52_SOCK_RX_READPTR 0x4028
#define W52_SOCK_RX_RD0 0x4028
#define W52_SOCK_RX_RD1 0x4029

#define W52_SOCK_RX_WRITEPTR 0x402A
#define W52_SOCK_RX_WR0 0x402A
#define W52_SOCK_RX_WR1 0x402B

#define W52_SOCK_IMR 0x402C

#define W52_SOCK_FRAGOFFSET 0x402D
#define W52_SOCK_FRAG0 0x402D
#define W52_SOCK_FRAG1 0x402E
